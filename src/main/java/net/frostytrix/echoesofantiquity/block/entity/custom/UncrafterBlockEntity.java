...
public class UncrafterBlockEntity extends BlockEntity implements ImplementedInventory, ExtendedScreenHandlerFactory<BlockPos>, SidedInventory {
    ...
    public UncrafterBlockEntity(BlockPos pos, BlockState state) {
        ...
        this.delegate = new PropertyDelegate() {
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0: UncrafterBlockEntity.this.progress = value; break;
                    case 1: UncrafterBlockEntity.this.maxProgress = value; break;
                }
            }
    ...
    private void giveIngredient(World world) {
        ...
        // Cleared so hasRecipe() rolls a new one next tick.
        nextOutput = ItemStack.EMPTY;
    }
