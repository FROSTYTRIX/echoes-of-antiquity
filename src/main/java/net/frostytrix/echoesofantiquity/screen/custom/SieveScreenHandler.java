...
public class SieveScreenHandler extends ScreenHandler {
    ...
    public SieveScreenHandler(int syncId, PlayerInventory playerInventory, BlockPos pos) {
    ...
    public SieveScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        ...
        this.addSlot(new Slot(inventory, 1, 34, 53){
            @Override
            public boolean canInsert(ItemStack stack) {
                return stack.isOf(ModItems.SOUL_FRAGMENT);
            }
        });
        this.addSlot(new Slot(inventory, 2, 90, 26){
            @Override
            public boolean canInsert(ItemStack stack) {
                return false;
            }
        ...
        this.addSlot(new Slot(inventory, 4, 126, 26){
            @Override
            public boolean canInsert(ItemStack stack) {
                return false;
            }
        });
        this.addSlot(new Slot(inventory, 5, 90, 44){
            @Override
            public boolean canInsert(ItemStack stack) {
                return false;
            }
        });
        this.addSlot(new Slot(inventory, 6, 108, 44){
            @Override
            public boolean canInsert(ItemStack stack) {
                return false;
            }
        });
        this.addSlot(new Slot(inventory, 7, 126, 44){
            @Override
            public boolean canInsert(ItemStack stack) {
                return false;
            }
